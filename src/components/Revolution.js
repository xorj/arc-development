  ...
  return (
    <Grid container direction="column">
      ...
      <Grid
        ...
        style={{ marginTop: "5em" }}
      >
        <Grid item container justify={matchesMD ? "center" : undefined} lg>
          <img
            src={vision}
            alt="mountain through binoculars"
            style={{
              maxWidth: matchesSM ? "90%" : "40em",
      ...
      >
        ...
        >
          ...
          <Grid item style={{ maxWidth: matchesMD ? "40em" : "20em" }}>
        ...
        >
          <img src={consultation} alt="handshake" style={{ maxWidth: "90%" }} />
        </Grid>
      </Grid>
      <Grid
        item
      ...
      >
        ...
        >
          <img
            ...
            style={{ maxWidth: "90%", maxHeight: "35em" }}
          />
        </Grid>
      </Grid>
      <Grid
      ...
      >
        ...
        <Grid
          ...
          style={{ alignSelf: "center" }}
        >
          <img src={launch} alt="rock" style={{ maxWidth: "90%", maxHeight: "35em" }} />
        </Grid>
      </Grid>
      <Grid
        item
